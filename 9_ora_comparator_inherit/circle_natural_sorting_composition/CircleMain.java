...
public class CircleMain {
    ...
    public static void main(String[] args) {
        ColoredCircle circle1 = new ColoredCircle(new Point(0, 0), 5, Color.RED);
        ColoredCircle circle2 = new ColoredCircle(new Point(0, 0), 1, Color.RED);
        ColoredCircle circle3 = new ColoredCircle(new Point(0, 0), 3, Color.RED);
